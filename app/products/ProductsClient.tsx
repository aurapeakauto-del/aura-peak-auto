...
// ✅ مكون الـ Modal الكبير - Component صحيح
function FullProductModal({ product, relatedProducts, onClose, onOpenOther }: {
    ...
    const shareProduct = (platform: string) => {
        ...
        if (platform === 'copy') {
            ...
            toast.showToast('تم نسخ الرابط', 'success');
        } else {
    ...
    const increaseQuantity = () => {
        ...
        else toast.showToast(`الكمية المتوفرة هي ${product.stock} قطع فقط`, 'warning');
    };
                        ...
                        <div>
                            ...
                            {product.stock > 0 ? (
                                <button onClick={() => {
                                    ...
                                    toast.showToast(`تمت إضافة ${quantity} قطع إلى السلة`, 'success');
                                }} className="w-full lg:w-auto px-12 py-4 bg-[#2c2c2c] text-white hover:bg-gray-800 rounded-lg">
                                    إضافة إلى السلة
                                </button>
                            ) : (
