...
export default function ProductsClient() {
    ...
    // فتح الـ Modal الصغير مع تحميل بيانات المنتج
    ...
    // فتح الـ Modal الكبير (يغلق الصغير أولاً)
    const openFullModal = () => {
        setModalProduct(null); // يخفي الصغير
        setFullModalOpen(true); // يظهر الكبير
    };

    // إغلاق الـ Modal الكبير وإعادة فتح الصغير
    const closeFullModal = () => {
        setFullModalOpen(false);
        // نرجع المنتج للـ Modal الصغير
        if (modalRelated.length > 0 || true) {
            setModalProduct(modalProduct); // ما زال موجود في state
        }
    };
    ...
    return (
        <div className="min-h-screen bg-[#faf7f2]">
            ...
            {/* ✅ Modal كبير - صفحة المنتج الكاملة */}
